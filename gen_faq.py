...
faqs = [
    ...
    ("Is there a free trial?", "Yes. Every team member gets one free practice session with no credit card required. After that, you can purchase individual practice sessions at $4.99 per session or become a member for the full platform. Membership billing is monthly and you can cancel anytime."),
