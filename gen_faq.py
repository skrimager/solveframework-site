...
faqs = [
    ...
    ("Is there a free trial?", "Yes. Every team member gets three free practice sessions with no credit card required. A five-person team can run fifteen real, scored practice conversations before spending a dollar. After that, billing is monthly and you can cancel anytime."),
